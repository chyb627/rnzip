...
import useMovie from '../../hooks/MovieReminder/useMovie';
import { RouteProp, useRoute } from '@react-navigation/native';
import { RootStackParamList } from '../../types/movieReminderType';
import Section from '../../components/MovieReminder/Section';
import People from '../../components/MovieReminder/People';
import YouTubeVideo from '../../components/MovieReminder/YouTubeVideo';
...
const MovieScreen = () => {
  ...
  const renderMovie = useCallback(() => {
    ...
    const { posterUrl, title, originalTitle, releaseDate, overview, crews, casts, videos } = movie;
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.titleSection}>
          <View style={styles.poster}>
            {posterUrl != null && <Image style={styles.poster} source={{ uri: posterUrl }} />}
          </View>
          ...
          <View style={styles.infoTexts}>
            ...
            <Text style={styles.releaseDateText}>{`개봉일: ${releaseDate}`}</Text>
          </View>
        </View>
          ...
          {youTubeVideos.map((video, index) => {
            return (
              <React.Fragment key={video.id}>
                ...
                {index + 1 < youTubeVideos.length && <View style={styles.verticalSeparator} />}
              </React.Fragment>
            );
          })}
        </Section>
